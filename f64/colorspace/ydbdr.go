...
// RGBToYDbDr converts sRGB to SECAM Y'DbDr Luma + Chroma */
func RGBToYDbDr(r, g, b float64) (y, db, dr float64) {
...
// YDbDrToRGB converts SECAM Y'DbDr to sRGB */
func YDbDrToRGB(y, db, dr float64) (r, g, b float64) {
